...
MoveNave_RecalculaPos:		; Recalcula posicao da Nave em funcao das Teclas pressionadas
  ...
  MoveNave_RecalculaPos_A:	; Move Nave para Esquerda
	call MoveNave_RecalculaPos_Dir
	loadn R1, #40
	loadn R2, #0
  ...
  MoveNave_RecalculaPos_S:	; Move Nave para Baixo
	...
	MoveNave_RecalculaPos_Dir:
		...
		load R1, FlagTiro
		cmp R0, R1
		jne MoveNave_RecalculaPos_Dir_Skip
		store dirNave, R2
		
	MoveNave_RecalculaPos_Dir_Skip:	
		pop R1
		pop R0
		rts
...
MoveTiro_RecalculaPos:
	...
	loadn R2, #'d'
	cmp R1, R2
	jeq MoveTiro_RecalculaPos_D
	
	loadn R2, #'a'
	cmp R1, R2
	jeq MoveTiro_RecalculaPos_A
	
	loadn R2, #'w'
	cmp R1, R2
	jeq MoveTiro_RecalculaPos_W
	
	loadn R2, #'s'
	cmp R1, R2
	jeq MoveTiro_RecalculaPos_S
...
tela6Linha5  : string "                                        "
tela6Linha6  : string "                                        "
tela6Linha7  : string "            PRESSIONE                   "
tela6Linha8  : string "                                        "
tela6Linha9  : string "             ENTER                      "
tela6Linha10 : string "                                        "
tela6Linha11 : string "                                        "
tela6Linha12 : string "                PARA                    "
tela6Linha13 : string "                                        "
tela6Linha14 : string "                                        "
tela6Linha15 : string "               INICIAR                  "
tela6Linha16 : string "                                        "
tela6Linha17 : string "                                        "
tela6Linha18 : string "                                        "
tela6Linha19 : string "                                        "
